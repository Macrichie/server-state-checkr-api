...
workers.performCheck = (originalCheckData) => {
  ...
  const path = parsedUrl.path; //We used path and not pathname coz we need the full query string
  ...
  // Instantiate the request object using either the http or https module imported above
